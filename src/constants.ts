...
export const IPC_COMMAND_PREFIX = 'mcp-vscode-debugger:';
...
// 配置键
export const CONFIG_SECTION_SERVER = 'mcp-vscode-debugger.server';
...
// MCP 客户端配置
export const MCP_CONFIG_SERVER_KEY = 'mcp-vscode-debugger';
